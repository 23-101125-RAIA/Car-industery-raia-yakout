...
function setAllText() {
  ...
  if (elem("title1-sec6-card1")) elem("title1-sec6-card1").innerHTML = "Switzerland Hyper Tire";
  if (elem("title1-sec6-card2")) elem("title1-sec6-card2").innerHTML = " Germany Stream Tire";
  if (elem("title1-sec6-card3")) elem("title1-sec6-card3").innerHTML = "Japan Sport Tire";
