...
function setAllText() {
  ...
  if (path.includes('product2.html') || !path.includes('product')) {
    if (elem("title-sec2")) elem("title-sec2").innerHTML = "McLaren Arturagt4";
    if (elem("text-sec2")) elem("text-sec2").innerHTML = "The McLaren Artura GT4 represents the pinnacle of hybrid supercar performance.Combining a lightweight carbon fibre architecture with a high-performance V6 hybrid powertrain, it delivers instant torque and blistering acceleration. Designed for the track but built for the driver, the Artura offers precision handling and an immersive experience.";
  }
  ...
  if (elem("title1-sec6-card1")) elem("title1-sec6-card1").innerHTML = "UK Track-Precision Tire";
  if (elem("title1-sec6-card2")) elem("title1-sec6-card2").innerHTML = " Japan Hybrid- Tire";
  if (elem("title1-sec6-card3")) elem("title1-sec6-card3").innerHTML = "taly GT Racing Tire";
