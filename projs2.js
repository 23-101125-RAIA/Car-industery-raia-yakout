...
document.getElementById("title1-sec6-card1").innerHTML = "UK Track-Precision Tire";
document.getElementById("title1-sec6-card2").innerHTML = " Japan Hybrid- Tire";
document.getElementById("title1-sec6-card3").innerHTML = "taly GT Racing Tire";
