...
function setAllText() {
  ...
  if (elem("title1-sec6-card1")) elem("title1-sec6-card1").innerHTML = "Japan Nismo Tire";
  if (elem("title1-sec6-card2")) elem("title1-sec6-card2").innerHTML = " USA StreetSport Tire";
  if (elem("title1-sec6-card3")) elem("title1-sec6-card3").innerHTML = "Italy Pro-Cornering Tire";
