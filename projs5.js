...
document.getElementById("title1-sec6-card1").innerHTML = "Germany Ultra-Grip Tire";
document.getElementById("title1-sec6-card2").innerHTML = "  USA TrackMax Tire";
document.getElementById("title1-sec6-card3").innerHTML = "Italy HyperSport Slick";
