...
function setAllText() {
  ...
  if (elem("title1-sec6-card1")) elem("title1-sec6-card1").innerHTML = "Germany Simen Tire";
  if (elem("title1-sec6-card2")) elem("title1-sec6-card2").innerHTML = "Japan Sport Drift Tire";
  if (elem("title1-sec6-card3")) elem("title1-sec6-card3").innerHTML = "Italy Racing Tire";
