...
function setAllText() {
  ...
  if (elem("title1-sec6-card1")) elem("title1-sec6-card1").innerHTML = "Japan GR Sport Tire";
  if (elem("title1-sec6-card2")) elem("title1-sec6-card2").innerHTML = " Germany Stability Tire";
  if (elem("title1-sec6-card3")) elem("title1-sec6-card3").innerHTML = "Korea  Soft Tire";
