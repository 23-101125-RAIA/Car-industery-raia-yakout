...
document.getElementById("title1-sec6-card1").innerHTML = "Japan GR Sport Tire";
document.getElementById("title1-sec6-card2").innerHTML = " Germany Stability Tire";
document.getElementById("title1-sec6-card3").innerHTML = "Korea  Soft Tire";
